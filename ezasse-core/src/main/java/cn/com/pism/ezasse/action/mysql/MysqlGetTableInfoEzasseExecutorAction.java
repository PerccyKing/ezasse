...
import cn.com.pism.ezasse.action.EzasseExecutorGetTableInfoActionParam;
 ...
 */
public class MysqlGetTableInfoEzasseExecutorAction implements EzasseExecutorAction<EzasseExecutorGetTableInfoActionParam, EzasseTableInfo> {
    ...
    @Override
    public EzasseTableInfo doAction(EzasseExecutorGetTableInfoActionParam actionParam) {
