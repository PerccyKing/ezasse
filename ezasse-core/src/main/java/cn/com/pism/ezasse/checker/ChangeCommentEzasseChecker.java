 ...
 * @author PerccyKing
 * @version 0.0.1
 * @date 2022/04/10 上午 11:22
 * @since 0.0.1
 */
public class ChangeCommentEzasseChecker extends EzasseChecker {
    /**
     * <p>
     * 判断代码块是否需要执行
     * </p>
    ...
    public boolean needToExecute(DataSource checkDataSource, String checkContent, EzasseExecutor executor) {
        return publicCheck(checkContent, executor, () -> {
            ...
            EzasseTableInfo info = IterableUtils.find(tableInfo, t -> t.getColumnComment().equals(split[3]));
            return info == null;
        });
    }
